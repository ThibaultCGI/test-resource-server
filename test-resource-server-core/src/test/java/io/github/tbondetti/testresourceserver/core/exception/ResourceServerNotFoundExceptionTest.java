...
class ResourceServerNotFoundExceptionTest {
    ...
    void constructorOk() {
        ...
        final ResourceServerNotFoundException exception1 = new ResourceServerNotFoundException(code, message);

        assertSame(code, exception1.getCode());
        assertSame(message, exception1.getMessage());

        final ResourceServerNotFoundException exception2 = new ResourceServerNotFoundException(code, message, exception1);
